      ...
      <div className="w-full max-w-2xl space-y-8 relative z-10">
        <div className="text-center space-y-4">
          ...
          <p className="text-[10px] text-gray-500 font-black uppercase tracking-[0.6em]">
            NATT-OS • SIG_BY_MASTER_NAT_001 • v1.1
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-3">
          {checks.length > 0 ? checks.map((c, i) => (
            ...
            <div className="py-10 text-center text-gray-600 animate-pulse text-xs font-mono uppercase tracking-widest">
              Scanning Codebase Shards...
            </div>
          )}
        </div>
        ...
        {status === 'PASSED' && onPassed && (
          <div className="pt-6 text-center animate-in fade-in zoom-in-95 duration-1000">
            ...
            <p className="mt-4 text-[9px] text-green-500 font-black uppercase tracking-widest">128 Nodes Authenticated as Master-Owned</p>
          </div>
        )}
      </div>
    </div>
