        ...
        <div className="space-y-4 mt-auto">
           <div className="flex gap-3">
              <div className="flex items-center bg-white/5 border border-white/10 rounded-xl px-4 py-2 shrink-0">
                 <button onClick={() => setQuantity(prev => Math.max(1, prev - 1))} className="text-gray-500 hover:text-white px-2">−</button>
                 ...
                 <button onClick={() => setQuantity(prev => Math.min(product.stock.available, prev + 1))} className="text-gray-500 hover:text-white px-2">+</button>
              </div>
              <button 
