...
export class PaymentEngine {
  static async createPayment(req: PaymentRequest): Promise<PaymentResponse> {
    // RUNTIME OPTIMIZATION: Removed artificial delay.
    // In a real app, this would be a fetch() to the backend.
    // For this runtime demo, we execute immediately.
    ...
    return { 
        paymentUrl: `https://sandbox.payment-gateway.vn/redirect/${transactionId}`, 
        qrCodeUrl, 
        transactionId 
    };
  }
